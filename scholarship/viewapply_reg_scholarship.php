...
<div class="container">
          ...
          <tr><td>Name</td><td>Scholarship Title</td><td>Scholarship type</td><td>Eligibility</td><td>Region</td><td>Awards</td><td>Deadline</td><td>About the Program</td><td>Applied Date</td><td>Status</td><td>Action</td></tr>
          <?php
		  $n=mysql_query("select * from reg_scholarship");
...
<td>$deadline</td><td>$aprogram</td><td>$stype</td><td>$edate</td><td>$status</td><td><a href='viewapply_reg_scholarship.php?reid=$reid&action=approve'>Approve</a></td></tr>";
		  }
		  ?>
          </table>
        </div>
